...
# Detects faces in a video using opencv deep-learning module dnn
...
ap.add_argument("-c", "--confidence", type=float, default=0.5, help="Min prob to filter weak detections")
args = vars(ap.parse_args())
...
vs = FileVideoStream(args["video"]).start() #for in variable:
time.sleep(1.0)
